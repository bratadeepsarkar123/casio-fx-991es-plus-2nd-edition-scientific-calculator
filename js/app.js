...
state.baseN = typeof BaseNMode !== 'undefined' ? new BaseNMode(state) : null;
state.eqn = typeof EqnMode !== 'undefined' ? new EqnMode(state) : null;
state.matrix = typeof MatrixMode !== 'undefined' ? new MatrixMode(state) : null;
state.vector = typeof VectorMode !== 'undefined' ? new VectorMode(state) : null;
state.stat = typeof StatMode !== 'undefined' ? new StatMode(state) : null;
state.table = typeof TableMode !== 'undefined' ? new TableMode(state) : null;
